...
class PharmacyManagementSystem:
    def __init__(self, root):
        ...
        img1=Image.open('C:\\Users\\LENOVO\\OneDrive\\Desktop\\phrama\\pharm.png')
        ...
        btnUpdateMed=Button(ButtonFrame,text="UPDATE",font=('arial',11,'bold'),width=13,bg="darkgreen",fg="white")
        btnUpdateMed.grid(row=0,column=1)

        btnDeleteMed=Button(ButtonFrame,text="DELETE",font=('arial',11,'bold'),width=13,bg="red",fg="white")
        btnDeleteMed.grid(row=0,column=2)

        btnresetMed=Button(ButtonFrame,text="RESET",font=('arial',11,'bold'),width=13,bg="darkgreen",fg="white")
        ...
        search_combo=ttk.Combobox(ButtonFrame,width=11,font=('arial',16,'bold'),state="readonly")
        search_combo['values']=("Ref","Medname","Lot")
        search_combo.grid(row=0,column=6)
        search_combo.current(0)

        txtsearch=Entry(ButtonFrame,bd=3,relief=RIDGE,width=11,font=('arial',16,'bold'))
        txtsearch.grid(row=0,column=7)

        searchbtn=Button(ButtonFrame,text="SEARCH",font=('arial',11,'bold'),width=13,bg="darkgreen",fg="white")
        searchbtn.grid(row=0,column=8)

        showAll=Button(ButtonFrame,text="SHOW ALL",font=('arial',11,'bold'),width=13,bg="darkgreen",fg="white")
        showAll.grid(row=0,column=9)

        lblrefno=Label(DataFrameLeft,font=('arial',11,'bold'),text="Reference No",padx=2)
        lblrefno.grid(row=0,column=0,sticky=W)

        conn=mysql.connector.connect(host="localhost",username="root",password="Prameya@1816",database="pavandb")
        ...
        img5=Image.open('C:\\Users\\LENOVO\\OneDrive\\Desktop\\phrama\\ecg.jpg')
        img5=img5.resize((200,75),Image.LANCZOS)
        self.photoimg5=ImageTk.PhotoImage(img5)
        b1=Button(self.root,image=self.photoimg5,borderwidth=0)
        b1.place(x=960,y=160)

        img6=Image.open('C:\\Users\\LENOVO\\OneDrive\\Desktop\\phrama\\tabb.jpg')
